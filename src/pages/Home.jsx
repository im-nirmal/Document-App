...
function Home() {
  ...
  const deleleDocs = async id => {
    ...
    setReaload(id);
    toast.error(`${docTitle} deleted successfully`);
  };
  ...
  const handleAdd = () => {
    postData();
    toast.success(`${docTitle} created successfully`);
    setShow(false);
  };
    ...
    <div >
      <div className='container'>
        <div  className='d-flex  justify-content-center align-items-center flex-column mt-5'>
          ...
          <button onClick={handleShow} className="btn btn-primary mt-3">Take a note...</button>
        </div>
